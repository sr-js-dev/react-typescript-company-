    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="ibsApp.productType.home.createOrEditLabel">Create or edit a ProductType</h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : productTypeEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="descriptionLabel" for="product-type-description">
                    Description
                  </Label>
                  <AvField id="product-type-description" type="text" name="description" />
                </AvGroup>
